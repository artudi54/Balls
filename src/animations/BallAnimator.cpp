...
namespace animations {
    BallAnimator::BallAnimator(model::BallParameters *redBallParameters, model::BallParameters *blueBallParameters,
                               QSizeF areaSize, QObject *parent)
        : QObject(parent)
    ...
    void BallAnimator::setRandomBallPosition(model::BallParameters *ballParameters) {
    ...
    void BallAnimator::updatePosition(model::BallParameters *ballParameters) {
    ...
    void BallAnimator::handleWallCollision(model::BallParameters *ballParameters) {
    ...
    bool BallAnimator::isOutsideRight(model::BallParameters* ballParameters) {
        return ballParameters->getPosition().x() + ballParameters->getRadius() > areaSize.width();
    }

    bool BallAnimator::isOutsideTop(model::BallParameters* ballParameters) {
        return ballParameters->getPosition().y() + ballParameters->getRadius() > areaSize.height();
    }

    bool BallAnimator::isOutsideLeft(model::BallParameters* ballParameters) {
        return ballParameters->getPosition().x() - ballParameters->getRadius() < 0.0;
    }

    bool BallAnimator::isOutsideBottom(model::BallParameters* ballParameters) {
